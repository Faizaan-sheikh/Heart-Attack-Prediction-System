...
def analysis():
    ...
    B, F, I = None, None, None
    C, G, K, L, M = None, None, None, None, None
    D, E, H, J = None, None, None, None

    try:
        B = selection()
    except Exception as e:
        messagebox.showerror("Missing", f"Please select gender! Error: {e}")
        return

    try:
        F = selection2()
    except Exception as e:
        messagebox.showerror("Missing", f"Please select fbs! Error: {e}")
        return

    try:
        I = selection3()
    except Exception as e:
        messagebox.showerror("Missing", f"Please select exang! Error: {e}")
        return

    try:
        C = int(selection4())
    except Exception as e:
        messagebox.showerror("Missing", f"Please select cp! Error: {e}")
        return

    try:
        G = int(restecg_combobox.get())
    except Exception as e:
        messagebox.showerror("Missing", f"Please select restecg! Error: {e}")
        return

    try:
        K = int(selection5())
    except Exception as e:
        messagebox.showerror("Missing", f"Please select slope! Error: {e}")
        return

    try:
        L = int(ca_combobox.get())
    except Exception as e:
        messagebox.showerror("Missing", f"Please select ca! Error: {e}")
        return

    try:
        M = int(thal_combobox.get())
    except Exception as e:
        messagebox.showerror("Missing", f"Please select thal! Error: {e}")
        return
    ...
    try:
        ...
        messagebox.showerror("Missing Data", f"Few Missing data entry! Error: {e}")
        return
...
def Info():
    ...
    #Icon_image
    #icon_image=PhotoImage(file="/Users/faizaansheikh/Faizz/Projects/Heart Attack Prediction System/Images/info.png")
    #Icon_window.iconphoto(False,icon_image)

    #Heading
    Label(Icon_window,text="Information Related to dataset",font="robot 20 bold").pack(padx=20,pady=20)

    #Info

    Label(Icon_window,text="age - age in years",font="arial 14").place(x=20,y=100)
    Label(Icon_window,text="sex - sex (1 = male; 0 = female)",font="arial 14").place(x=20,y=130)
    Label(Icon_window,text="cp - chest pain type (0 = typical angina; 1 = atypical angina; 2 = non-anginal pain; 3 = asymptomatic)",font="arial 14").place(x=20,y=160)
    Label(Icon_window,text="trestbps - resting blood pressure (in mm Hg on admission to the hospital)",font="arial 14").place(x=20,y=190)
    Label(Icon_window,text="chol - serum cholestoral in mg/dl",font="arial 14").place(x=20,y=220)
    Label(Icon_window,text="fbs - fasting blood sugar > 120 mg/dl (1 = true; 0 = false)",font="arial 14").place(x=20,y=250)
    Label(Icon_window,text="restecg - resting electrocardiographic results (0 = normal; 1 = having ST-T; 2 = hypertrophy)",font="arial 14").place(x=20,y=280)
    Label(Icon_window,text="thalach - maximum heart rate achieved",font="arial 14").place(x=20,y=310)
    Label(Icon_window,text="exang - exercise induced angina (1 = yes; 0 = no)",font="arial 14").place(x=20,y=340)
    Label(Icon_window,text="oldpeak - ST depression induced by exercise relative to rest",font="arial 14").place(x=20,y=370)
    Label(Icon_window,text="slope - the slope of the peak exercise ST segment (0 = upsloping; 1 = flat; 2 = downsloping)",font="arial 14").place(x=20,y=400)
    Label(Icon_window,text="ca - number of major vessels (0-3) colored by flourosopy",font="arial 14").place(x=20,y=430)
    Label(Icon_window,text="thal - 0 = normal; 1 = fixed defect; 2 = reversable defect",font="arial 14").place(x=20,y=460)
...
## Clear - we can clear more entry  fields
...
def Save():
    ...
    Save_Data_MySql(B2,C2,int(D2),int(E2),int(G2),int(I2),int(J2),int(K2),int(L2),int(M2),float(N2),int(O2),int(P2),int(Q2),int(prediction[0]))
...
image_icon = PhotoImage(file="/Users/faizaansheikh/Faizz/Projects/Heart Attack Prediction System/Images/icon.png")
root.iconphoto(False, image_icon)

##header section 2
logo = PhotoImage(file = "/Users/faizaansheikh/Faizz/Projects/Heart Attack Prediction System/Images/header.png")
...
Entry_image = PhotoImage(file ="/Users/faizaansheikh/Faizz/Projects/Heart Attack Prediction System/Images/Rounded Rectangle 1.png")
Entry_image2 = PhotoImage(file="/Users/faizaansheikh/Faizz/Projects/Heart Attack Prediction System/Images/Rounded Rectangle 2.png")
...
cp_combobox = Combobox(Detail_entry,values=['0 = typical angina','1 = atypical angina','2 = non-aginal pain','3 = asymptomatic'],font="arial 12",state="r",width=14)
restecg_combobox = Combobox(Detail_entry,values=['0','1','2'],font="arial 12",state="r",width=14)
slope_combobox = Combobox(Detail_entry,values=['0 = upslopping','1 = flat','2 = downsloping'],font="arial 12",state="r",width=14)
...
cp_combobox.place(x=43,y=47)
restecg_combobox.place(x=69,y=88)
slope_combobox.place(x=58,y=128)
ca_combobox.place(x=43,y=168)
thal_combobox.place(x=49,y=208)
...
trestbps_entry.place(x = 320,y = 88)
chol_entry.place(x = 320,y = 128)
thalach_entry.place(x = 320,y = 168)
oldpeak_entry.place(x = 320,y = 208)

########################################### REPORT ###########################################

square_report_image = PhotoImage(file = "/Users/faizaansheikh/Faizz/Projects/Heart Attack Prediction System/Images/Report.png")
report_background= Label(image=square_report_image,bg = background)
report_background.place(x=1121, y = 340)
...
graph_image = PhotoImage(file="/Users/faizaansheikh/Faizz/Projects/Heart Attack Prediction System/Images/graph.png")
...
analysis_button = PhotoImage(file = "/Users/faizaansheikh/Faizz/Projects/Heart Attack Prediction System/Images/Analysis.png")
Button(root, image = analysis_button,bd = 0, bg = background, cursor = 'hand2',command=analysis).place(x = 1130, y = 240)


######################################## info Button ########################################

info_button = PhotoImage(file = "/Users/faizaansheikh/Faizz/Projects/Heart Attack Prediction System/Images/info.png")
Button(root, image = info_button ,bd = 0, bg = background, cursor = 'hand2',command=Info).place(x = 10, y = 240)


######################################## Save Button ########################################

save_button = PhotoImage(file = "/Users/faizaansheikh/Faizz/Projects/Heart Attack Prediction System/Images/save.png")
Button(root, image = save_button ,bd = 0, bg = background, cursor = 'hand2',command=Save).place(x = 1370, y = 250)

######################################## Smoking/Non Smoking Button ########################################
...
smoking_icon = PhotoImage(file="/Users/faizaansheikh/Faizz/Projects/Heart Attack Prediction System/Images/smoker.png")
non_smoking_icon = PhotoImage(file="/Users/faizaansheikh/Faizz/Projects/Heart Attack Prediction System/Images/non-smoker.png")
...
logout_icon = PhotoImage(file = "/Users/faizaansheikh/Faizz/Projects/Heart Attack Prediction System/Images/logout.png")
